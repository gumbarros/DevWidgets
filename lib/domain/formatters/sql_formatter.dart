...
class SQLFormatter {
  ...
  String transformString(String str, List<Function> fns) => fns.fold(str, (acc, fn) => fn(acc));

  List<String> createShiftArr(String tab) => new List<String>.generate(100, (int i) => '\n' + (tab * i));
  ...
  List<String> splitIfEven(int i, String str, String tab) => i % 2 == 0 ? splitSql(str, tab) : [str];
}
